import os
import logging
from data_wrangling import preprocess_data, save_data
from data_extraction import fetch_data
from file_handler import save_dataset_to_json
...
def main():
    ...
    try:
        ...
        raw_filepath = os.path.join(config['file_paths']['raw'], 'raw_iowa_data.json')
        ...
        if data:
            ...
            save_dataset_to_json(data, raw_filepath)

            # Preprocess data
            cleaned_data = preprocess_data(data)

            # Save cleaned data to JSON file
            save_data(cleaned_data, clean_filepath)
        else:
